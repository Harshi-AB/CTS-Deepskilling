-- ============================================================
-- MySQL schema + seed data for the 'country' table
-- Run this in MySQL Workbench / mysql client against a real
-- MySQL 8.0 instance to reproduce the exact schema this project
-- simulates in memory (see MySQLDatabase.java / CountryDataLoader.java).
-- ============================================================
